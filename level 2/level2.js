...
const colors = ["Red", "Blue", "Green", "Orange", "Purple", "Pink", "Brown", "Cyan", 'Chartreuse', 'Magenta'];
    ...
    element.addEventListener('click', () => {
        ...
        if (colorToMatch === color) {
            ...
            if (revealedCount === tileCount){
                alert('You beat level 2 move on to level 3!')
                window.location.assign('../level 3/level3.html')
            }
